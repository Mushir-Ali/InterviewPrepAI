export const CARD_BG = [
  ...
  { id: 6, bgcolor: 'linear-gradient(135deg, #f5f5f5 0%, #fbfbdb 100%)' },
  { id: 7, bgcolor: 'linear-gradient(135deg, #fff4fc 0%, #fff9fa 100%)' },
  { id: 8, bgcolor: 'linear-gradient(135deg, #e8fef3 0%, #f7fff6 100%)' },
...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas — no generic stuff.",
  },
  {
    id: "02",
