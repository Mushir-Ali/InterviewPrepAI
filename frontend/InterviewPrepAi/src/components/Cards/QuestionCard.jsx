...
const QuestionCard = ({
  ...
  return <>
    <div className='bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/20 border border-gray-100/60 group'>
        <div className='flex items-start justify-between cursor pointer'>
            ...
            <div className='fllex items-center justify-end ml-4 relative'>
